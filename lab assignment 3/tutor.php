...
if(isset($_GET['searchBar'])) {
    ...
    $sqlTutor = "SELECT * FROM tbl_tutors WHERE tutor_name LIKE '%$searchbar%'";
...
<body>
    ...
    <form name="searchForm" action="tutor.php" method="get">
    <div class="w3-card w3-container w3-padding w3-margin w3-round" id="searchBar" style="text-align:center">

        <input name ="searchBar" type="text" placeholder="Search tutors here">
